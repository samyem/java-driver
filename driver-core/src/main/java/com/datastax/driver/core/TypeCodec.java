 ...
 *
 * <ol>
 *     <li>{@link #accepts(DataType, TypeToken)}}: returns true if the codec accepts both the given Java type and the CQL type;</li>
 *     <li>{@link #accepts(DataType)}}}: returns true if the codec accepts the given CQL type, regardless of its Java type;</li>
 *     <li>{@link #accepts(TypeToken)}}: returns true if the codec accepts the given Java type, regardless of its CQL type;</li>
 *     <li>{@link #accepts(Object)}}; returns true if the given object can be serialized by the codec.</li>
 * </ol>
 *
...
public abstract class TypeCodec<T> {
     ...
     * is "ANY", e.g. <code>accepts(null, TypeToken.of(String.class))</code>
     ...
     */
    public final boolean accepts(DataType cqlType, TypeToken javaType) {
        return (cqlType == null || accepts(cqlType)) && (javaType == null || accepts(javaType));
    }
        ...
        public ByteBuffer serialize(Map<K, V> value) {
            ...
            for (Map.Entry<K, V> entry : value.entrySet()) {
                ...
                try {
                    ...
                    // With collections, the element type has not been checked, so it can throw
                    throw new InvalidTypeException("Invalid type for map key: " + e.getMessage());
                }
                ByteBuffer bbv;
                try {
                    ...
                    // With collections, the element type has not been checked, so it can throw
                    throw new InvalidTypeException("Invalid type for map value: " + e.getMessage());
                }
                bbs.add(bbk);
                bbs.add(bbv);
