 ...
 * - ALL_FIELDS : If a value of a field is null, it will be stored as NULL
 *                into the database. This strategy is the default.
 * - NOT_NULL_FIELDS : If a value of a field is null, the field will be
